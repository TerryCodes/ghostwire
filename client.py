        ...
        try:
            ...
            if channel_id!="main":
                ...
                if self.conn_data_seq_enabled:
                    ...
                    logger.info(f"Child {channel_id} lost during striped mode, {striped_count} striped connections will continue with remaining {len(available_children)} children")
